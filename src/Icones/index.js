export function MdiEyeSettings(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
				d='M12 9a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3m0 8a5 5 0 0 1-5-5a5 5 0 0 1 5-5a5 5 0 0 1 5 5a5 5 0 0 1-5 5m0-12.5c-4.86 0-9.22 3-11 7.5c2.39 6.08 9.25 9.06 15.33 6.67c3.05-1.2 5.47-3.61 6.67-6.67c-1.78-4.5-6.14-7.5-11-7.5M7 22h2v2H7v-2m4 0h2v2h-2v-2m4 0h2v2h-2v-2Z'></path>
		</svg>
	)
}

export function FluentDarkTheme20Filled(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 20 20' {...props}>
			<path
				fill='currentColor'
				d='M10 3.5a6.5 6.5 0 1 1 0 13v-13ZM10 2a8 8 0 1 0 0 16a8 8 0 0 0 0-16Z'></path>
		</svg>
	)
}

export function IcOutlineSearch(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
...
export function Fa6BrandsWpexplorer(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 512 512' {...props}>
			<path
				fill='currentColor'
				d='M512 256c0 141.2-114.7 256-256 256C114.8 512 0 397.3 0 256S114.7 0 256 0s256 114.7 256 256zm-32 0c0-123.2-100.3-224-224-224C132.5 32 32 132.5 32 256s100.5 224 224 224s224-100.5 224-224zM160.9 124.6l86.9 37.1l-37.1 86.9l-86.9-37.1l37.1-86.9zm110 169.1l46.6 94h-14.6l-50-100l-48.9 100h-14l51.1-106.9l-22.3-9.4l6-14l68.6 29.1l-6 14.3l-16.5-7.1zm-11.8-116.3l68.6 29.4l-29.4 68.3L230 246l29.1-68.6zm80.3 42.9l54.6 23.1l-23.4 54.3l-54.3-23.1l23.1-54.3z'></path>
		</svg>
	)
}

export function IcOutlineBookmarks(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
				d='M15 7v12.97l-4.21-1.81l-.79-.34l-.79.34L5 19.97V7h10m4-6H8.99C7.89 1 7 1.9 7 3h10c1.1 0 2 .9 2 2v13l2 1V3c0-1.1-.9-2-2-2zm-4 4H5c-1.1 0-2 .9-2 2v16l7-3l7 3V7c0-1.1-.9-2-2-2z'></path>
		</svg>
	)
}

export function GgProfile(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
...
export function IcOutlineMessage(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
				d='M4 4h16v12H5.17L4 17.17V4m0-2c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2H4zm2 10h12v2H6v-2zm0-3h12v2H6V9zm0-3h12v2H6V6z'></path>
		</svg>
	)
}
...
export function RiLogoutCircleRLine(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
				d='M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2a9.985 9.985 0 0 1 8 4h-2.71a8 8 0 1 0 .001 12h2.71A9.985 9.985 0 0 1 12 22zm7-6v-3h-8v-2h8V8l5 4l-5 4z'></path>
		</svg>
	)
}

export function MdiFeather(props) {
	return (
		<svg width='3rem' height='3rem' viewBox='0 0 24 24' {...props}>
			<path
				fill='currentColor'
				d='M22 2s-7.64-.37-13.66 7.88C3.72 16.21 2 22 2 22l1.94-1c1.44-2.5 2.19-3.53 3.6-5c2.53.74 5.17.65 7.46-2c-2-.56-3.6-.43-5.96-.19C11.69 12 13.5 11.6 16 12l1-2c-1.8-.34-3-.37-4.78.04C14.19 8.65 15.56 7.87 18 8l1.21-1.93c-1.56-.11-2.5.06-4.29.5c1.61-1.46 3.08-2.12 5.22-2.25c0 0 1.05-1.89 1.86-2.32Z'></path>
		</svg>
	)
}

export function FluentGif16Regular(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 16 16' {...props}>
			<path
				fill='currentColor'
				d='M5.052 6.706c.481-.05.853.037.986.103a.5.5 0 1 0 .447-.894c-.351-.176-.928-.267-1.537-.203c-.96.1-1.948.934-1.948 2.297c0 1.385 1.054 2.3 2.3 2.3c.58 0 1.1-.272 1.397-.553c.262-.248.303-.577.303-.783v-.964a.5.5 0 0 0-.5-.5h-.807a.5.5 0 1 0 0 1H6v.464a.427.427 0 0 1-.006.071a1.126 1.126 0 0 1-.694.265c-.731 0-1.3-.505-1.3-1.3c0-.818.567-1.252 1.052-1.303ZM9 6.21a.5.5 0 0 0-1 0v3.6a.5.5 0 1 0 1 0v-3.6Zm1.5-.5a.5.5 0 0 0-.5.5v3.6a.5.5 0 0 0 1 0V8.506l1.003-.006a.5.5 0 0 0-.006-1L11 7.506v-.797h1.5a.5.5 0 0 0 0-1h-2ZM3.5 2A2.5 2.5 0 0 0 1 4.5v7A2.5 2.5 0 0 0 3.5 14h9a2.5 2.5 0 0 0 2.5-2.5v-7A2.5 2.5 0 0 0 12.5 2h-9ZM2 4.5A1.5 1.5 0 0 1 3.5 3h9A1.5 1.5 0 0 1 14 4.5v7a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 11.5v-7Z'></path>
		</svg>
	)
}
...
export function ZondiconsCloseSolid(props) {
	return (
		<svg width='1em' height='1em' viewBox='0 0 20 20' {...props}>
			<path
				fill='currentColor'
				d='M2.93 17.07A10 10 0 1 1 17.07 2.93A10 10 0 0 1 2.93 17.07zM11.4 10l2.83-2.83l-1.41-1.41L10 8.59L7.17 5.76L5.76 7.17L8.59 10l-2.83 2.83l1.41 1.41L10 11.41l2.83 2.83l1.41-1.41L11.41 10z'></path>
		</svg>
	)
}
